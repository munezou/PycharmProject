...
cafe = bytes('caf辿', encoding='utf_8')
...
for codec in ['latin_1', 'utf_8', 'utf_16']:
    print(codec, 'El Ni単o'.encode(codec), sep='\t')
...
u16le = 'El Ni単o'.encode('utf_16le')
print('list(u16le) = \n{0}'.format(list(u16le)))
print()
print('---< big endian >---')
u16be = 'El Ni単o'.encode('utf_16be')
print('list(u16be) = \n{0}'.format(list(u16be)))
print()
...
open('cafe.txt', 'w', encoding='utf_8').write('caf辿')
