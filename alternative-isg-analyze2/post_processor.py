...
class PostProcessor:
    ...
    def __init__(self, post_processor_parameter: PostProcessorArguments) -> None:
        ...
        self.__light_on_epoch = post_processor_parameter.light_on_epoch
    ...
    def start(self):
        ...
        if self.__ai_version.is_ai_version1_1():
            ...
            self.aasm_filter_4()
            self.aasm_filter_5()
        elif self.__ai_version.is_ai_version2_0() or self.__ai_version.is_ai_version2_1_0():
            print("using version2_0 or version2_1_0 filter.")
            pass
        elif self.__ai_version.is_ai_version2_1_1():
            print("using version2_1_1 filter.")
            self.aasm_filter_1()
            self.sorem_filter()
            self.aasm_filter_2()
        elif self.__ai_version.is_ai_version2_1_2():
            print("using version2_1_2 filter.")
            self.aasm_filter_1()
            self.sorem_filter()
            self.aasm_filter_2()
            self.aasm_filter_3()
        elif self.__ai_version.is_ai_version2_1_3():
            print("using version2_1_3 filter.")
            self.aasm_filter_1()
            self.sorem_filter()
            self.aasm_filter_2()
            self.aasm_filter_3()
            self.aasm_filter_4()
        elif self.__ai_version.is_ai_version2_1_4():
            print("using version2_1_4 filter.")
            self.aasm_filter_1()
            self.sorem_filter()
            self.aasm_filter_2()
            self.aasm_filter_3()
            self.aasm_filter_4()
            self.aasm_filter_5()
        elif self.__ai_version.is_ai_version2_1_5():
            print("using version2_1_5 filter.")
            self.aasm_filter_1()
            self.sorem_filter()
            self.aasm_filter_2()
            self.aasm_filter_3()
            self.aasm_filter_4()
            self.aasm_filter_5()
            self.light_on_filter()
        else:
            raise Exception("An unsupported AI version was specified.")
    ...
    def light_on_filter(self):
        for i in range(self.__light_on_epoch, len(self.__scoring_result)):
            if self.__scoring_result[i] != Stage.Wake:
                self.__scoring_result[i] = Stage.Wake
