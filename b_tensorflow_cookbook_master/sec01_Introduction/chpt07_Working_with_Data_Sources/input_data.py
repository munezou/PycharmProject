...
class _DataSet(object):
	...
	@deprecated(None, 'Please use alternatives such as official/mnist/_DataSet.py from tensorflow/models.')
...
def read_data_sets(
		train_dir, fake_data=False, one_hot=False, dtype=dtypes.float32, reshape=True, validation_size=5000,
