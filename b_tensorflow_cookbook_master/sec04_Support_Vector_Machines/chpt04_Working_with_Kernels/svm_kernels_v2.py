...
sq_dists = tf.add(tf.subtract(dist, tf.multiply(2., tf.matmul(x_data, tf.transpose(a=x_data)))), tf.transpose(a=dist))
...
# Declare optimizer
my_opt = tf.compat.v1.train.GradientDescentOptimizer(0.002)
